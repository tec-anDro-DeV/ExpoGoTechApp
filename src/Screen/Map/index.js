  ...
  render() {
    ...
    return (     
      ...
      <SafeAreaView style={{height: "100%"}} >
          ...
          <Header onLayout={(event) => { this.find_dimesions_header(event.nativeEvent.layout) }}
            title={this.state.title_page}
            onPress={() => this.back()}
          />
          
          <View onLayout={(event) => { this.find_dimesions_cont1(event.nativeEvent.layout) }}  style={styles.container}>
