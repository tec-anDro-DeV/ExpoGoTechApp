          ...
          if (valid) {
            ...
            if (is_con) {
              ...
              let data_response = await API.new_order(
                ...
                this.state.new_contract,
                this.state.new_zone,
                this.state.new_status,
                this.state.new_notes,
                this.state.new_surface,
                this.state.new_service,
                this.state.new_square_footage,
                this.state.new_priority
              );
              console.log(data_response);
              if (data_response.message == 'invalid_login') {
              } else {
  ...
  render() {
    return (
      <SafeAreaView style={[container.container]}>
        <Header title='New Work Order' onPress={() => this.back()} />
            ...
            <List style={{ marginVertical: 20, marginHorizontal: 15 }}>
                  ...
                  >
                    ...
                    >
                      <TextInput
                        ...
                        onChangeText={(itemValue, itemIndex) => this.setState({ new_address: itemValue })}
                      ></TextInput>
                    </View>
                  </View>
                </View>
              ...
              >
                <TextInput
                  ...
                  onChangeText={(itemValue, itemIndex) => this.setState({ new_notes: itemValue })}
              ...
              <View style={{ flexDirection: 'row', paddingTop: 10, paddingHorizontal: 8 }}>
                ...
                <View style={{ width: '50%', textAlign: 'right' }}>
                  ...
                  >
                    <Text style={{ textAlign: 'right' }}>Calculator</Text>
                  </TouchableOpacity>
                </View>
              </View>
              <View
              ...
              >
                ...
                >
                  <TextInput
                    ...
                    onChangeText={(itemValue, itemIndex) => this.setState({ new_square_footage: itemValue })}
                  ></TextInput>
                </View>
              </View>
